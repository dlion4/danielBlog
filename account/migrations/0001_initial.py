    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=15, null=True, validators=[django.core.validators.RegexValidator(message='Please Enter a valid phone number', regex=['\\?0?+{9,15}$'])], verbose_name='Contact Phone')),
