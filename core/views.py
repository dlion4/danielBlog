    ...
    def get(self, *args, **kwargs):
        ...
        try:
            context.update({
                ...
                "technology":random.sample(list(self.model.objects.filter(tag__name__iexact="Technology").all()),k=6),
                "lifestyle":random.sample(list(self.model.objects.filter(tag__name__iexact="Lifestyle").all()), k=6),
                "education":random.sample(list(self.model.objects.filter(tag__name__iexact="Education").all()), k=6),
                "politics":random.sample(list(self.model.objects.filter(tag__name__iexact="Politics").all()), k=6),
                "sports":random.sample(list(self.model.objects.filter(tag__name__iexact="Sports").all()), k=6),
                "health":random.sample(list(self.model.objects.filter(tag__name__iexact="Health").all()), k=6),
                ...
                "popularLife": random.sample(list(self.model.objects.filter(Q(category__iexact="POPULAR") & Q(tag__name__iexact="Lifestyle")).all()),k=4),

                # ---------------------
                # =================== POPULAR PER TAGS ===============

                "popularLifestyle": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="Lifestyle") & Q(category__iexact="POPULAR")).all()), k=1)[0],
                "popularSports": random.sample(list(self.model.objects.filter(category__iexact="POPULAR").filter(tag__name__iexact="sports").all()),k=4),
                "popularSport": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="sports") & Q(category__iexact="POPULAR")).all()), k=1)[0],
                "popularpolitics": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="politics") & Q(category__iexact="POPULAR")).all()), k=4),
                "popularpolitic": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="politics") & Q(category__iexact="POPULAR")).all()), k=1)[0],

                "populartechnologies": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="technology") & Q(category__iexact="POPULAR")).all()), k=4),
                "populartechnology": random.sample(list(self.model.objects.filter(Q(tag__name__iexact="technology") & Q(category__iexact="POPULAR")).all()), k=1)[0],
                ...
                "mostPopular": random.sample(list(self.model.objects.filter(category__iexact="POPULAR").all()), k=4),

                "mustRead": random.sample(list(self.model.objects.filter(category__iexact="MEDICAL").all()),k=4),
                "reminder": random.sample(list(self.model.objects.all().order_by("-id")), k=4),
